...
def main(args):
    ...
    for epoch in range(DYPRAG_TRAIN_EPOCH):
        ...
        save_dir = os.path.join(ROOT_DIR, "projector", f'{args.model_name}_hidden{args.projector_p}_sample{args.sample_rate}_lr{args.dyprag_learning_rate}_self_attention')
